			...
			content.append("<br><br>All Channels on the Systems:<table>");
				...
				for(ChannelEntityClass ch : channels)
				{
					...
					if(DBWrapper.checkUserChannel(username, channel_name))
					{
						...
						content.append("<tr><td><a href='/servlet/displayXml?channel_name=" + channel_name + "'>" + channel_name + 
								"</a></td><td><a href='/servlet/deleteChannel?channel_name=" + channel_name + "'>delete</a></td></tr>");
					}
				}
