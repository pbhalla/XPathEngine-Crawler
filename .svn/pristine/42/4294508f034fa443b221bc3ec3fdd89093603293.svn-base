...
public class TxnChain {
    ...
    public static class RevertInfo {
        ...
        public String toString() {
            return "revertLsn=" + DbLsn.getNoFormatString(revertLsn) +
                ...
                " isIntermediateVersion=" + isIntermediateVersion;
        }
    }
     ...
     * in the tree before, which might or might not be the same logical node.
