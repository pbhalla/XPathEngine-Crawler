...
public class RobotsTxtInfo {
	...
	private HashMap<String,Long> crawlDelays;
	...
	public RobotsTxtInfo(){
		...
		crawlDelays = new HashMap<String,Long>();
	...
	/**
	 * clearing the values of disallowed links
	 * @param key
	 */
	
	public void clearDisallowedLinks(String key)
	{
		if(disallowedLinks.containsKey(key))
		{
			disallowedLinks.get(key).clear();
		}	
	}
	/**
	 * clearing the values of allowed links
	 * @param key
	 */
	
	public void clearAllowedLinks(String key)
	{
		if(allowedLinks.containsKey(key))
		{
			allowedLinks.get(key).clear();
		}	
	}
	...
	public void addCrawlDelay(String key, Long value){
	...
	public long getCrawlDelay(String key)
	{
	...
	/**
	 * check if the given host name is in allowedLinks hash map
	 * @param key
	 * @return
	 */
	
	public boolean allowedContainAgent(String key)
	{
		return allowedLinks.containsKey(key);
	}
	/**
	 * check if the disallowed links contains the host name
	 * @param key
	 * @return
	 */
	
	public boolean disallowedContainAgent(String key)
	{
