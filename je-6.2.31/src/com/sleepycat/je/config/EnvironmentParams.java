...
public class EnvironmentParams {
    ...
    /**
     * If true, a new evictor is used, which is more efficient and does a
     * better aproximation of an LRU policy than the old evictor. Eventually,
     * the old evictor will be completely removed, and when that happens,
     * this parameter will also be removed.
     */
    public static final BooleanConfigParam ENV_USE_NEW_EVICTOR =
        new BooleanConfigParam("je.env.useNewEvictor",
                               true,         // default
                               false,        // mutable
                               false);       // forReplication
    ...
    public static final IntConfigParam LOG_FILE_WARM_UP_BUF_SIZE =
        new IntConfigParam("je.log.fileWarmUpReadSize",
            Integer.valueOf(128),      // min
            null,                      // max
            Integer.valueOf(10485760), // default
            false,                     // mutable
            false);                    // forReplication
