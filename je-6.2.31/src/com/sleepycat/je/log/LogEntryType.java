...
public class LogEntryType {
     ...
     */
    public static final int LOG_VERSION = 10;
    ...
    /**
     * The highest log version of any replicable log entry class, so that
     * replication can determine the earliest log version it can generate.
     * This field is needed to account for cases where log entry format changes
     * only apply to non-replicable entries, as was the case for log version
     * 10.
     */
    /*
     * TODO: Modify the requirements for writing replicable log entries in the
     * the current version minus one format to account for the fact that there
     * is a gap in the numbering, since no replicable entry classes had format
     * changes for log versions 9 or 10.  Make this change the next time the
     * format of a replicable log entry is modified.
     */
     ...
     */
    private static final int MAX_TYPE_NUM = 37;
