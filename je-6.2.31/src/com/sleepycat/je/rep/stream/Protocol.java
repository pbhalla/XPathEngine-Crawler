...
public class Protocol extends BinaryProtocol {
     ...
     * version, or null if the version is not supported.
     */
    public static Protocol get(final RepNode repNode,
                               final int protocolVersion) {
        return get(repNode, protocolVersion, protocolVersion);
    }
    ...
    public static Protocol get(final RepNode repNode,
                               final int protocolVersion,
                               final int maxProtocolVersion) {
        return get(repNode, protocolVersion, maxProtocolVersion,
    ...
    public static Protocol get(final RepNode repNode,
        ...
        final int groupFormatVersion = group.getFormatVersion();
        if (groupFormatVersion >= RepGroupImpl.FORMAT_VERSION_3) {
            minProtocolVersion = VERSION_5;
        }

        return get(repNode, protocolVersion, minProtocolVersion,
                   maxProtocolVersion, writeLogVersion);
    }
    ...
    static Protocol get(final RepNode repNode,
         ...
         */
        return new Protocol(repNode, protocolVersion, maxProtocolVersion,
                            writeLogVersion);
    }
    ...
    static Protocol getProtocol(final RepNode repNode,
        ...
        assert repNode != null;
        return new Protocol(repNode, protocolVersion, protocolVersion,
                            LogEntryType.LOG_VERSION);
    }
