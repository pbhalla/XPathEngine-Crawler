...
public class CursorConfig implements Cloneable {
     ...
     * <p>
     * Note that {@link CacheMode#EVICT_BIN} and {@link CacheMode#MAKE_COLD}
     * are incompatible with the non-sticky feature.  When these cache modes
     * are used, the cursor will behave as if were sticky, regardless of
     * whether non-sticky is set to true using this method.
     * <p>
